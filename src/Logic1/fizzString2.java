...
public class fizzString2 {
    ...
    // by both 3 and 5, use "FizzBuzz". Note: the % "mod" operator computes the remainder after division, so 23 % 10 yields 3.
    ...
    public String fizzString2(int n) {
        String bb = String.valueOf(n)+'!';
        if(n%3==0) bb="Fizz!";
        if(n%5==0) bb="Buzz!";
        if(n%3==0 && n%5==0) bb = "FizzBuzz!";
        return bb;
    }
}
